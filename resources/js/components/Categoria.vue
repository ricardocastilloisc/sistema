          ...
          <div class="form-group row">
            <div class="col-md-6">
              <div class="input-group">
                ...
                >
                <button @click="listarCategoria(1,buscar,criterio)" type="submit" class="btn btn-primary">
  ...
  methods: {
    ...
    desactivarCategoria(id) {
      ...
      swalWithBootstrapButtons({
        title: "¿Estas seguro en desactivar este registro?",
        text: "No puedes revetir esta opción",
        type: "warning",
        showCancelButton: true,
        confirmButtonText: "¡Si, desactivar el registro!",
        ...
        if (result.value) {
          ...
          axios
            ...
            .then(function(response) {
              me.cerrarModal();
              //acuerdate que me.paginacion 
              //es para no perder la pagina actual donde estas posicionado
    ...
    activarCategoria(id) {
      ...
      swalWithBootstrapButtons({
        title: "¿Estas seguro en activar este registro?",
        text: "No puedes revetir esta opción",
        type: "warning",
        showCancelButton: true,
        confirmButtonText: "¡Si, activar el registro!",
        cancelButtonText: "¡No, cancela!",
        reverseButtons: true
      }).then(result => {
        if (result.value) {
